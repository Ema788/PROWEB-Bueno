        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="./Examen5-Tablas.html" class="menu-link">
                    <div data-i18n="Error">Examen 1</div>
                  </a>
                </li>
                <li class="menu-item active">
                  <a href="./Examen2-tablas.php" class="menu-link">
                    <div data-i18n="Under Maintenance">Examen 2</div>
                  </a>
                </li>
              </ul>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link" href="./HTML-Tablas.html"><i class="bx bxs-file-html"></i> Introducción</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link " href="./Examen5-Tablas.html"
                        ><i class="bx bx-book-content me-1"></i> Examen 1</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="./Examen2-tablas.php"
...
&lt;/table&gt;
                            ...
                            <h4><label for="">Agrega el encabezado de la tabla con el valor "Edad":</label></h4>
