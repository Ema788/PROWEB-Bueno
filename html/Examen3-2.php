        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">HTML Básico  / Imagenes / </span> Examen 2</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link" href="./HTML-Imagenes.html"><i class="bx bxs-file-html"></i> Introducción</a>
                    </li>
                    <li class="nav-item">
                      ...
                      <div class="container">
                        <form method="post" action="#">
                          ...
                          <a href="HTML-Imagenes.html">
                            ...
                            <label for="exampleInputEmail1"><h4 class="titleh4">Observa lo siguiente:</h4></label><br>
                            <h3>
                            <pre class="lang:default decode:true">
&lt;img src="scream.png" ?????="250" height="400"&gt;
                            </pre>
                            </h3>
                            <h4><label for="">Usa los atributos de imagen HTML para establecer el tamaño de la imagen en 250 píxeles de ancho y 400 píxeles de alto:</label></h4>
